...
public class ServiceId {
    ...
    public static ServiceId valueOf(String s) throws InvalidValueException {
        ...
        if (matcher.matches() && matcher.groupCount() >= 1) {
            SpecificationViolationReporter.report("No service ID token, defaulting to " + UNKNOWN + ": " + s, null);
        ...
        if (tokens.length == 4) {
            SpecificationViolationReporter.report("Trying a simple colon-split of: " + s, null);
